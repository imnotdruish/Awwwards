...
All design credits go to **[Zentry](https://zentry.com/)**. This project is created purely for **educational purposes** and is not intended for commercial use. This was solely used to work on programming skills with React, TailwindCSS and intro to using GSAP.

This repository contains code referenced from an in-depth tutorial available on our YouTube channel, <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a>. Tech Stack information and Assets are from JS Mastery's README from their project. 
